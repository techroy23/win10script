...
$tweaks = @(
	...
	"EnableWiFiSense",             # "EnableWiFiSense",
	"EnableSmartScreen",         # "EnableSmartScreen",
	"EnableWebSearch",             # "EnableWebSearch",
	"EnableAppSuggestions",        # "EnableAppSuggestions",
	"EnableActivityHistory",       # "EnableActivityHistory",
	"EnableBackgroundApps",        # "EnableBackgroundApps",
	"EnableLocationTracking",      # "EnableLocationTracking",
	"EnableMapUpdates",            # "EnableMapUpdates",
	"EnableFeedback",              # "EnableFeedback",
	"EnableTailoredExperiences",   # "EnableTailoredExperiences",
	"AdvertisingID",         # "EnableAdvertisingID",
	"EnableCortana",               # "EnableCortana",
	"EnableErrorReporting",        # "EnableErrorReporting",
	"SetP2PUpdateLocal",          # "SetP2PUpdateInternet",
	"EnableDiagTrack",             # "EnableDiagTrack",
	"EnableWAPPush",               # "EnableWAPPush",

	### Security Tweaks ###
	"SetUACLow",                  # "SetUACHigh",
	"EnableSharingMappedDrives",  # "DisableSharingMappedDrives",
	"EnableAdminShares",           # "EnableAdminShares",
	"EnableSMB1",                # "EnableSMB1",
	"EnableSMBServer",           # "EnableSMBServer",
	"EnableLLMNR",               # "EnableLLMNR",
	"SetCurrentNetworkPrivate",     # "SetCurrentNetworkPublic",
	"SetUnknownNetworksPrivate",  # "SetUnknownNetworksPublic",
	"EnableNetDevicesAutoInst",	# "DisableNetDevicesAutoInst",
	"EnableCtrldFolderAccess",	# "EnableCtrldFolderAccess",
	...
	"EnableSleepTimeout",        # "EnableSleepTimeout",
	...
	"EnableNewAppPrompt",          # "EnableNewAppPrompt",
